const HeaderComponent = () => {
  return (
    ...
    <div className="flex flex-row justify-items-center justify-between px-2  pr-2 py-2">
      <h1 className="font-bold text-xl">POS System</h1>
      <div>
        <input
          className="w-[50rem] appearance-none border-2 border-gray-300 rounded-md w py-2 px-3 text-gray-800  pl-10"
          type="text" 
          placeholder="Search, Menu, Order and More..."
        />
        <div className="relative">
          <svg
            className="absolute left-3 bottom-3 h-4 w-4 text-gray-500"
            width="18"
            height="16"
            viewBox="0 0 18 16"
            fill="none"
      ...
      <div  className="w-12 h-12 rounded-full border bg-white flex items-center justify-center"><img src="" alt="" /></div>
      </div>
     <div className="absolute top-[2rem] left-[2.5rem]">Admin</div>
    </div>
