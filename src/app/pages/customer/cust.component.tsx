...
import CreateUser from "./cust.create/create.cust";
import {
  Table,
  TableBody,
  TableCaption,
...
import useUser from "./cust.hook";
import Tablerow from "../user/user.components/tableRow";
import LoadingSpinner from "@/app/layout/loading/loading";
import DeleteUsers from "../user/user.delete/delete.user";
import UpdateUser from "./cust.update/update.cust";
        ...
        <main className="w-full bg-white relative">
            ...
            <section className="mt-4 overflow-y-auto h-[70dvh]">
                <Table className="bg-white border-2 relative border-gray-200 drop-shadow-md">
                    <TableCaption>No more Customer data.</TableCaption>
                    <TableHeader className="bg-gray-100">
                        <TableRow>
                            ...
                            <TableHead className="text-sm w-[20ch] text-slate-900 font-semibold">Loyalty Point</TableHead>
